...
import org.farng.mp3.util.StringUtil;

import com.ibm.icu.text.CharsetDetector;
import com.ibm.icu.text.CharsetMatch;
import com.string.encode.StringEncodeType;
...
public abstract class AbstractMP3Object extends java.lang.Object {
	...
	public void readByteArray(final byte[] arr, final int offset) {
		...
		if (StringEncodeType.isTheEncode(encoding)) {
			try {
				str = new String(arr, "GBK");
//				byte[] b = StringUtil.doTheBytes(str.getBytes());
//				str = new String(b, "UTF-8");
			...
			try {
				byte[] b = StringUtil.doTheBytesForISO8859_1(arr);
			...
			try {
				byte[] b = StringUtil.doTheBytes(arr);
